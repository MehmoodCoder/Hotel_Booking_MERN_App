    ...
    <>
      <div className="relative min-h-screen w-full flex flex-col justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url(https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-no-repeat bg-cover bg-center py-12 md:py-20">
        ...
        <div className="relative z-10 flex flex-col items-start w-full max-w-7xl">
          ...
          <p className="max-w-xl mt-4 text-sm sm:text-base md:text-lg text-gray-300 font-light leading-relaxed drop-shadow-[0_4px_12px_rgba(0,0,0,0.9)]">
            Book premium hotels, cozy resorts, and exclusive suites worldwide at
            the guaranteed best competitive prices today.
          </p>

          {/* Updated Dark Glassmorphism Form */}
          <form className="bg-[#1e1e1e]/90 backdrop-blur-md text-white rounded-2xl p-4 sm:p-5 mt-8 shadow-2xl w-full border border-gray-800 grid grid-cols-1 sm:grid-cols-2 xl:flex xl:flex-row items-end gap-4">
            ...
            <div className="flex-1 w-full min-w-0">
              ...
              <input
                ...
                id="destinationInput"
                type="text"
                className="w-full rounded-lg border border-gray-700 bg-[#141414] px-3.5 py-2 text-sm font-medium text-white placeholder-gray-500 outline-none focus:border-[#00F0FF] focus:ring-1 focus:ring-[#00F0FF] transition-all"
            ...
            <div className="flex-1 w-full min-w-0">
              ...
              <input
                id="checkIn"
                type="date"
                className="w-full rounded-lg border border-gray-700 bg-[#141414] px-3.5 py-2 text-sm font-medium text-white [color-scheme:dark] outline-none focus:border-[#00F0FF] focus:ring-1 focus:ring-[#00F0FF] transition-all"
              />
            </div>
