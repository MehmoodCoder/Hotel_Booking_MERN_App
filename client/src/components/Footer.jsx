      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12">
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="flex items-center gap-4 pt-2 text-gray-400">
            <a href="https://www.instagram.com/mehmood_mh56" className="hover:text-white transition-colors">
            ...
            <a href="https://x.com/MehmoodHassan56" className="hover:text-white transition-colors">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" />
              </svg>
            </a>
            <a href="https://www.facebook.com/share/1EabhnRp6p" className="hover:text-white transition-colors">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M9 8H6v4h3v12h5V12h3.642L18 8h-4V6.333C14 5.374 14.5 5 15.5 5H18V0h-3.808C10.592 0 9 1.583 9 4.615V8z" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/mehmood-hassan-7604a03b1" className="hover:text-white transition-colors">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
        ...
        <div className="space-y-3">
          ...
          >
            <input
              ...
              required
              className="w-full px-3 py-2 text-xs bg-gray-900 border border-gray-800 rounded-l-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-600"
            />
            <button
              type="submit"
              className="px-3.5 py-2 text-xs font-medium text-black bg-white rounded-r-lg hover:bg-gray-200 transition-colors shrink-0 cursor-pointer"
            >
              &rarr;
            </button>
          </form>
