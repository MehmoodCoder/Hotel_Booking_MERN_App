...
const Footer = () => {
  return (
    <footer className="w-full text-gray-300 bg-[#111111] border-t border-gray-800/60 px-6 md:px-16 lg:px-24 xl:px-32 pt-16 pb-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <button
              type="submit"
              className="px-3.5 py-2 text-xs font-bold text-black bg-[#00F0FF] rounded-r-lg hover:bg-cyan-300 transition-colors shrink-0 cursor-pointer"
            >
              &rarr;
            </button>
          </form>
